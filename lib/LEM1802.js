(function(window){
    ...
    LEM1802.prototype.setupMemoryMap = function () {
        this.cpu.removeListener(this.screenRam);
        this.cpu.removeListener(this.fontRam);
        this.cpu.removeListener(this.paletteRam);

        this.screenRam = this.cpu.onSet(this.screenRam.address, cols * rows, function(key, val) {
        ...
        this.fontRam = this.cpu.onSet(this.fontRam.address, 256, function(key, val) {
        ...
        this.paletteRam = this.cpu.onSet(this.paletteRam.address, 16, function(key, val) {
            for(var i = 0; i < this.screenRam.length; i++) {
